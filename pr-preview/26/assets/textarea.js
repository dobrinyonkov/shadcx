...
`,t=class extends HTMLElement{constructor(...e){super(...e),this._textarea=null}static{this.observedAttributes=[`placeholder`,`value`,`rows`,`disabled`,`required`,`readonly`,`aria-invalid`]}get placeholder(){return this.getAttribute(`placeholder`)??``}set placeholder(e){this.setAttribute(`placeholder`,e)}get value(){return this._textarea?.value??this.getAttribute(`value`)??``}set value(e){this.setAttribute(`value`,e),this._textarea&&(this._textarea.value=e)}get rows(){return this.getAttribute(`rows`)??`3`}set rows(e){this.setAttribute(`rows`,e)}get disabled(){return this.hasAttribute(`disabled`)}set disabled(e){this.toggleAttribute(`disabled`,e)}get required(){return this.hasAttribute(`required`)}set required(e){this.toggleAttribute(`required`,e)}get readonly(){return this.hasAttribute(`readonly`)}set readonly(e){this.toggleAttribute(`readonly`,e)}get ariaInvalid(){return this.getAttribute(`aria-invalid`)}set ariaInvalid(e){e===null?this.removeAttribute(`aria-invalid`):this.setAttribute(`aria-invalid`,e)}connectedCallback(){this.shadowRoot||this.attachShadow({mode:`open`}),this.render()}attributeChangedCallback(){this.render()}render(){if(!this.shadowRoot)return;let t=this.value;this.shadowRoot.innerHTML=`
      ...
      ></textarea>
    `,this._textarea=this.shadowRoot.querySelector(`textarea`),this._textarea&&(this._textarea.value=t)}};customElements.get(`shadcx-textarea`)||customElements.define(`shadcx-textarea`,t);