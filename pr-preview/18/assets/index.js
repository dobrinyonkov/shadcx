...
&lt;/a&gt;</code></pre>
  ...
  color: hsl(142 84% 25%);
    ...
    `}};B=z([I(`badge-page`)],B);var We=t({ButtonPage:()=>V}),V=class extends F{static{this.styles=[R,c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;button class="scx-ghost" disabled&gt;Ghost&lt;/button&gt;</code></pre>
    ...
    `}};V=z([I(`button-page`)],V);var Ge=t({CheckboxPage:()=>H}),H=class extends F{constructor(...e){super(...e),this._checked=!1}static{this.styles=[R,c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/script&gt;</code></pre>
    ...
    `}};z([L()],H.prototype,`_checked`,void 0),H=z([I(`checkbox-page`)],H);var Ke=t({ComboboxPage:()=>W}),U=[`Next.js`,`SvelteKit`,`Nuxt.js`,`Remix`,`Astro`],W=class extends F{constructor(...e){super(...e),this._singleValue=``,this._autocompleteValue=``,this._multipleValues=[]}static{this.styles=[R,c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `]}_onSingleValueChange(e){let t=e.currentTarget;this._singleValue=t.value}_onOptionListClick(e){let t=e.target;if(!(t instanceof Node))return;let n=(t instanceof Element?t:t.parentElement)?.closest(`button[data-value]`);if(!n)return;let r=new Set(this._multipleValues),i=n.dataset.value||``;r.has(i)?r.delete(i):r.add(i),this._multipleValues=U.filter(e=>r.has(e))}_onAutocompleteInput(e){let t=e.currentTarget;this._autocompleteValue=t.value}render(){return D`
      <h1>Combobox</h1>
      <p class="desc">
...
&lt;/select&gt;</code></pre>
      ...
      <div class="preview">
        ...
        >
          <option value="">Select a framework</option>
          ${U.map(e=>D`<option value=${e}>${e}</option>`)}
        </select>
...
&lt;/select&gt;</code></pre>
      ...
      <div class="preview">
        ...
        <datalist id="framework-options">
          ${U.map(e=>D`<option value=${e}></option>`)}
        </datalist>
...
&lt;/select&gt;</code></pre>
    ...
    `}};z([L()],W.prototype,`_singleValue`,void 0),z([L()],W.prototype,`_autocompleteValue`,void 0),z([L()],W.prototype,`_multipleValues`,void 0),W=z([I(`combobox-page`)],W);var qe=t({InputPage:()=>G}),G=class extends F{static{this.styles=[R,c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};G=z([I(`input-page`)],G);var Je=t({OverviewPage:()=>K}),K=class extends F{static{this.styles=c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `]}get _basePaletteSet(){return this._dark?$e:q}get _stylePresetSet(){return this._dark?et:J}get _themeStyle(){return Xe.map(e=>`--${e}: ${this._theme[e]}`).join(`; `)}get _radiusValue(){return Number.parseFloat(this._theme.radius.replace(`rem`,``))}get _fontLabel(){return Y.find(e=>e.value===this._theme[`font-sans`])?.label??`Custom`}_createTheme(){let e=this._dark?Qe:Ze,t=this._basePaletteSet[this._base],n=this._stylePresetSet[this._style];return{...e,...t,...n}}_syncDocumentTheme(){let e=document.documentElement.classList.contains(`dark`);if(e===this._dark)return;let t=this._theme[`font-sans`];this._dark=e,this._theme={...this._createTheme(),"font-sans":t}}_setToken(e,t){let n={...this._theme,[e]:t};e===`primary`&&(n[`primary-foreground`]=this._foregroundFor(t)),e===`accent`&&(n[`accent-foreground`]=this._foregroundFor(t)),e===`destructive`&&(n[`destructive-foreground`]=this._foregroundFor(t)),this._theme=n}_setColor(e,t){let n=t.currentTarget;this._setToken(e,this._hexToHsl(n.value))}_setRadius(e){let t=e.currentTarget;this._theme={...this._theme,radius:`${t.value}rem`}}_setFont(e){this._theme={...this._theme,"font-sans":e}}_applyBase(e){let t=e.currentTarget;this._base=t.value,this._theme={...this._theme,...this._basePaletteSet[t.value]}}_applyStyle(e){let t=e.currentTarget;this._style=t.value,this._theme={...this._theme,...this._stylePresetSet[t.value]}}_shuffle(){let e=Object.keys(q),t=Object.keys(J),n=e[Math.floor(Math.random()*e.length)],r=t[Math.floor(Math.random()*t.length)],i=Math.floor(Math.random()*360),a=(i+72+Math.floor(Math.random()*120))%360,o=(i+32)%360,s=this._dark?58+Math.floor(Math.random()*14):38+Math.floor(Math.random()*13),c=this._dark?16:94,l=`${i} ${64+Math.floor(Math.random()*18)}% ${s}%`,u=`${a} ${52+Math.floor(Math.random()*18)}% ${c}%`,d=[.25,.375,.5,.625,.75,1][Math.floor(Math.random()*6)];this._base=n,this._style=r,this._theme={...this._theme,...this._basePaletteSet[n],...this._stylePresetSet[r],primary:l,"primary-foreground":this._foregroundFor(l),accent:u,"accent-foreground":this._foregroundFor(u),ring:l,radius:`${d}rem`,"chart-1":`${o} 76% 56%`,"chart-2":`${(o+58)%360} 62% 44%`,"chart-3":`${(o+123)%360} 48% 42%`,"chart-4":`${(o+188)%360} 78% 62%`,"chart-5":`${(o+247)%360} 70% 58%`}}async _copyCss(){try{await navigator.clipboard.writeText(this._buildCss()),this._copied=!0,window.setTimeout(()=>{this._copied=!1},1800)}catch{this._copied=!1}}_buildCss(){let e=Xe.map(e=>`  --${e}: ${this._theme[e]};`).join(`
`);return`${this._dark?`.dark`:`:root`} {\n${e}\n}\n`}_hslToHex(e){let t=e.match(/([\d.]+)\s+([\d.]+)%\s+([\d.]+)%/);if(!t)return`#000000`;let n=Number.parseFloat(t[1])/360,r=Number.parseFloat(t[2])/100,i=Number.parseFloat(t[3])/100;if(r===0){let e=Math.round(i*255);return this._toHex(e,e,e)}let a=(e,t,n)=>{let r=n;return r<0&&(r+=1),r>1&&--r,r<1/6?e+(t-e)*6*r:r<1/2?t:r<2/3?e+(t-e)*(2/3-r)*6:e},o=i<.5?i*(1+r):i+r-i*r,s=2*i-o,c=Math.round(a(s,o,n+1/3)*255),l=Math.round(a(s,o,n)*255),u=Math.round(a(s,o,n-1/3)*255);return this._toHex(c,l,u)}_hexToHsl(e){let t=Number.parseInt(e.slice(1,3),16)/255,n=Number.parseInt(e.slice(3,5),16)/255,r=Number.parseInt(e.slice(5,7),16)/255,i=Math.max(t,n,r),a=Math.min(t,n,r),o=0,s=0,c=(i+a)/2;if(i!==a){let e=i-a;s=c>.5?e/(2-i-a):e/(i+a),o=i===t?(n-r)/e+(n<r?6:0):i===n?(r-t)/e+2:(t-n)/e+4,o/=6}return`${Math.round(o*360)} ${Math.round(s*100)}% ${Math.round(c*100)}%`}_toHex(e,t,n){return`#${[e,t,n].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`}_foregroundFor(e){let t=e.match(/([\d.]+)\s+([\d.]+)%\s+([\d.]+)%/);return(t?Number.parseFloat(t[3]):50)>62?`0 0% 9%`:`0 0% 98%`}_renderSelectControl(e,t,n,r){return D`
        ...
        <aside class="controls" aria-label="Theme controls">
          ...
          <div class="controls-body">
            <div class="control-group">
              ${this._renderSelectControl(`Style`,this._style,Object.keys(J),e=>this._applyStyle(e))}
              ${this._renderSelectControl(`Base Color`,this._base,Object.keys(q),e=>this._applyBase(e))}
              ${this._renderSelectControl(`Font`,this._fontLabel,Y.map(e=>e.label),e=>{let t=e.currentTarget,n=Y.find(e=>e.label===t.value);n&&this._setFont(n.value)})}
            </div>

            <div class="control-group">
              ${tt.map(e=>this._renderColorControl(e.label,e.token,e.hint))}
            </div>
            ...
            <div class="control-group">
              ...
              ${nt.map(e=>this._renderColorControl(e.label,e.token,`Chart token`))}
            </div>
    ...
    `}};z([L()],X.prototype,`_base`,void 0),z([L()],X.prototype,`_style`,void 0),z([L()],X.prototype,`_copied`,void 0),z([L()],X.prototype,`_dark`,void 0),z([L()],X.prototype,`_theme`,void 0),X=z([I(`theme-generator-page`)],X);var rt=t({ThemingPage:()=>Z}),Z=class extends F{static{this.styles=c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};Z=z([I(`theming-page`)],Z);var it=Object.assign({"./pages/badge-page.ts":Ue,"./pages/button-page.ts":We,"./pages/checkbox-page.ts":Ge,"./pages/combobox-page.ts":Ke,"./pages/input-page.ts":qe,"./pages/overview-page.ts":Je,"./pages/theme-generator-page.ts":Ye,"./pages/theming-page.ts":rt}),at=new Map([[`/`,{elementName:`overview-page`,label:`Introduction`,wide:!1}],[`theming`,{elementName:`theming-page`,label:`Theming`,wide:!1}],[`theme-generator`,{elementName:`theme-generator-page`,label:`Theme Generator`,wide:!0}]]),ot=[`badge`,`button`,`input`,`checkbox`,`combobox`];function st(e){return e.split(`-`).map(e=>`${e.charAt(0).toUpperCase()}${e.slice(1)}`).join(` `)}function ct(e){let t=e.split(`/`).pop()?.replace(/-page\.ts$/,``)??``;return t===`overview`?`/`:t}var Q=Object.keys(it).map(e=>{let t=ct(e),n=at.get(t);return{route:t,elementName:n?.elementName??`${t}-page`,label:n?.label??st(t),wide:n?.wide??!1}}),lt=[`/`,`theming`,`theme-generator`].map(e=>Q.find(t=>t.route===e)).filter(e=>!!e),ut=Q.filter(e=>!at.has(e.route)).sort((e,t)=>{let n=ot.indexOf(e.route),r=ot.indexOf(t.route);return(n===-1?2**53-1:n)-(r===-1?2**53-1:r)||e.label.localeCompare(t.label)});function dt(e){return Q.find(t=>t.route===e)??Q.find(e=>e.route===`/`)??{route:`/`,elementName:`overview-page`,label:`Introduction`,wide:!1}}function ft(e){return D`
    <section>
      <h1>${st(e)}</h1>
      <p>This page has not been registered yet.</p>
    </section>
  `}var pt=class extends F{constructor(...e){super(...e),this.active=``}static{this.styles=c`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}_renderNavItem(e){let t=e.route===`/`?`#/`:`#/${e.route}`;return D`
    ...
    `}_isActive(e){return this.active===e?`active`:``}render(){return D`
      <nav class="nav">
        ...
        ${lt.map(e=>this._renderNavItem(e))}

        <div class="nav-section">Components</div>
        ${ut.map(e=>this._renderNavItem(e))}

      </nav>
    `}};z([ze({type:String})],pt.prototype,`active`,void 0),pt=z([I(`app-sidebar`)],pt);var $=class extends F{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`,t=e===`/`?`/`:e.replace(/^\//,``);this._page=t,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=c`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=dt(this._page).wide?`content wide`:`content`;return D`
      <!-- topbar (mobile only) -->
      <header class="topbar">
        <button
          class="menu-btn"
    ...
    `}_renderPage(){let e=dt(this._page);if(!customElements.get(e.elementName))return ft(this._page);let t=Pe(e.elementName);return Ie`<${t}></${t}>`}};z([L()],$.prototype,`_page`,void 0),z([L()],$.prototype,`_sidebarOpen`,void 0),z([L()],$.prototype,`_dark`,void 0),$=z([I(`app-layout`)],$);