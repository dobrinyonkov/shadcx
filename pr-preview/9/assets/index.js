...
`;function W(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var G=class extends z{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1}static{this.styles=[U,o`
    :host {
      display: inline-flex;
    }
  ...
  `]}render(){return k`
    ...
    `}};W([V({type:String,reflect:!0})],G.prototype,`variant`,void 0),W([V({type:String,reflect:!0})],G.prototype,`size`,void 0),W([V({type:Boolean,reflect:!0})],G.prototype,`disabled`,void 0),G=W([B(`shadcx-button`)],G);var K=class extends z{constructor(...e){super(...e),this.variant=`default`}static{this.styles=[U,o`
      :host {
        display: inline-flex;
      }
    ...
    `}};W([V({type:String,reflect:!0})],K.prototype,`variant`,void 0),K=W([B(`shadcx-badge`)],K);var q=class extends z{constructor(...e){super(...e),this.type=`text`,this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.ariaInvalid=null}static{this.styles=[U,o`
    :host {
      display: flex;
    }
  ...
  `]}render(){return k`
      ...
      >
    `}};W([V({type:String})],q.prototype,`type`,void 0),W([V({type:String})],q.prototype,`placeholder`,void 0),W([V({type:Boolean,reflect:!0})],q.prototype,`disabled`,void 0),W([V({type:Boolean,reflect:!0})],q.prototype,`required`,void 0),W([V({type:Boolean,reflect:!0})],q.prototype,`readonly`,void 0),W([V({type:String,attribute:`aria-invalid`})],q.prototype,`ariaInvalid`,void 0),q=W([B(`shadcx-input`)],q);var J=class extends z{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaInvalid=null}static{this.styles=[U,o`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `]}get _state(){return this.indeterminate?`indeterminate`:this.checked?`checked`:`unchecked`}_toggle(){this.disabled||(this.indeterminate?(this.indeterminate=!1,this.checked=!0):this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked,indeterminate:this.indeterminate,state:this._state},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return k`
    ...
    `}};W([V({type:Boolean,reflect:!0})],J.prototype,`checked`,void 0),W([V({type:Boolean,reflect:!0})],J.prototype,`indeterminate`,void 0),W([V({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),W([V({type:String,attribute:`aria-invalid`})],J.prototype,`ariaInvalid`,void 0),J=W([B(`shadcx-checkbox`)],J);var Y=class extends z{constructor(...e){super(...e),this.checked=!1,this.disabled=!1,this.size=`default`,this.ariaInvalid=null}static{this.styles=[U,o`
      :host {
        display: inline-flex;
        vertical-align: middle;
      }
    ...
    `]}_toggle(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return k`
      <button
        part="root"
        class="root"
        type="button"
    ...
    `}};W([V({type:Boolean,reflect:!0})],Y.prototype,`checked`,void 0),W([V({type:Boolean,reflect:!0})],Y.prototype,`disabled`,void 0),W([V({type:String,reflect:!0})],Y.prototype,`size`,void 0),W([V({type:String,attribute:`aria-invalid`})],Y.prototype,`ariaInvalid`,void 0),Y=W([B(`shadcx-switch`)],Y);var X=class extends z{constructor(...e){super(...e),this.active=``}static{this.styles=o`
    :host {
      display: flex;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}render(){let e=e=>this.active===e?`active`:``;return k`
      <nav class="nav">
        ...
        <a
          class="nav-item ${e(`switch`)}"
          href="#/switch"
          @click=${e=>this._navigate(`switch`,e)}
        >
          Switch
        </a>

      </nav>
    `}};W([V({type:String})],X.prototype,`active`,void 0),X=W([B(`app-sidebar`)],X);var Oe=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_navigateBadge(e){e.preventDefault(),location.hash=`badge`}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}render(){return k`
      <h1>shadcx</h1>
      <p class="lead">
...
&lt;script type="module" src="https://dobrinyonkov.github.io/shadcx/assets/index.js"&gt;&lt;/script&gt;</code></pre>
    ...
    `}};Oe=W([B(`overview-page`)],Oe);var ke=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};ke=W([B(`theming-page`)],ke);var Ae=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;shadcx-button variant="ghost" disabled&gt;Ghost&lt;/shadcx-button&gt;</code></pre>
    ...
    `}};Ae=W([B(`button-page`)],Ae);var je=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/a&gt;</code></pre>
  ...
  color: hsl(142 84% 25%);
    ...
    `}};je=W([B(`badge-page`)],je);var Me=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};Me=W([B(`input-page`)],Me);var Z=class extends z{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/label&gt;</code></pre>
    ...
    `}};W([H()],Z.prototype,`_checked`,void 0),Z=W([B(`checkbox-page`)],Z);var Q=class extends z{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_onCheckedChange(e){let t=e.currentTarget;this._checked=!!t.checked}_onCardClick(e){let t=e.currentTarget.querySelector(`shadcx-switch`);t?.disabled||t.click()}render(){return k`
      <h1>Switch</h1>
      <p class="desc">
...
&lt;shadcx-switch size="lg"&gt;&lt;/shadcx-switch&gt;</code></pre>
    ...
    `}};W([H()],Q.prototype,`_checked`,void 0),Q=W([B(`switch-page`)],Q);var $=class extends z{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`;this._page=e,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=this._dark?`☀`:`☽`;return k`
    ...
    `}_renderPage(){switch(this._page){case`badge`:return k`<badge-page></badge-page>`;case`button`:return k`<button-page></button-page>`;case`input`:return k`<input-page></input-page>`;case`checkbox`:return k`<checkbox-page></checkbox-page>`;case`switch`:return k`<switch-page></switch-page>`;case`theming`:return k`<theming-page></theming-page>`;default:return k`<overview-page></overview-page>`}}};W([H()],$.prototype,`_page`,void 0),W([H()],$.prototype,`_sidebarOpen`,void 0),W([H()],$.prototype,`_dark`,void 0),$=W([B(`app-layout`)],$);