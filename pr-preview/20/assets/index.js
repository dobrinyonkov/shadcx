...
&lt;/div&gt;</code></pre>
  ...
  `}_navigateBadge(e){e.preventDefault(),location.hash=`badge`}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}_navigateCheckbox(e){e.preventDefault(),location.hash=`checkbox`}_navigateCombobox(e){e.preventDefault(),location.hash=`combobox`}_navigateThemeGenerator(e){e.preventDefault(),location.hash=`theme-generator`}render(){return D`
    ...
    `}};q=B([L(`overview-page`)],q);var Je=t({SwitchPage:()=>J}),J=class extends I{constructor(...e){super(...e),this._checked=!1}static{this.styles=[z,c`
  ...
  `]}_onSwitchChange(e){this._checked=e.currentTarget.checked}render(){return D`
      <h1>Switch</h1>
...
`);return`${this._dark?`.dark`:`:root`} {\n${e}\n}\n`}_hslToHex(e){let t=e.match(/([\d.]+)\s+([\d.]+)%\s+([\d.]+)%/);if(!t)return`#000000`;let n=Number.parseFloat(t[1])/360,r=Number.parseFloat(t[2])/100,i=Number.parseFloat(t[3])/100;if(r===0){let e=Math.round(i*255);return this._toHex(e,e,e)}let a=(e,t,n)=>{let r=n;return r<0&&(r+=1),r>1&&--r,r<1/6?e+(t-e)*6*r:r<1/2?t:r<2/3?e+(t-e)*(2/3-r)*6:e},o=i<.5?i*(1+r):i+r-i*r,s=2*i-o,c=Math.round(a(s,o,n+1/3)*255),l=Math.round(a(s,o,n)*255),u=Math.round(a(s,o,n-1/3)*255);return this._toHex(c,l,u)}_hexToHsl(e){let t=Number.parseInt(e.slice(1,3),16)/255,n=Number.parseInt(e.slice(3,5),16)/255,r=Number.parseInt(e.slice(5,7),16)/255,i=Math.max(t,n,r),a=Math.min(t,n,r),o=0,s=0,c=(i+a)/2;if(i!==a){let e=i-a;s=c>.5?e/(2-i-a):e/(i+a),o=i===t?(n-r)/e+(n<r?6:0):i===n?(r-t)/e+2:(t-n)/e+4,o/=6}return`${Math.round(o*360)} ${Math.round(s*100)}% ${Math.round(c*100)}%`}_toHex(e,t,n){return`#${[e,t,n].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`}_foregroundFor(e){let t=e.match(/([\d.]+)\s+([\d.]+)%\s+([\d.]+)%/);return(t?Number.parseFloat(t[3]):50)>62?`0 0% 9%`:`0 0% 98%`}_renderSelectControl(e,t,n,r){return D`
        ...
        <aside class="controls" aria-label="Theme controls">
          ...
          <div class="controls-body">
            <div class="control-group">
              ${this._renderSelectControl(`Style`,this._style,Object.keys(X),e=>this._applyStyle(e))}
              ${this._renderSelectControl(`Base Color`,this._base,Object.keys(Y),e=>this._applyBase(e))}
              ${this._renderSelectControl(`Font`,this._fontLabel,tt.map(e=>e.label),e=>{let t=e.currentTarget,n=tt.find(e=>e.label===t.value);n&&this._setFont(n.value)})}
            </div>

            <div class="control-group">
              ${nt.map(e=>this._renderColorControl(e.label,e.token,e.hint))}
            </div>
            ...
            <div class="control-group">
              ...
              ${rt.map(e=>this._renderColorControl(e.label,e.token,`Chart token`))}
            </div>
    ...
    `}};B([R()],Z.prototype,`_base`,void 0),B([R()],Z.prototype,`_style`,void 0),B([R()],Z.prototype,`_copied`,void 0),B([R()],Z.prototype,`_dark`,void 0),B([R()],Z.prototype,`_theme`,void 0),Z=B([L(`theme-generator-page`)],Z);var it=t({ThemingPage:()=>at}),at=class extends I{static{this.styles=c`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};at=B([L(`theming-page`)],at);var ot=Object.assign({"./pages/badge-page.ts":He,"./pages/button-page.ts":Ue,"./pages/checkbox-page.ts":We,"./pages/combobox-page.ts":Ge,"./pages/input-page.ts":Ke,"./pages/overview-page.ts":qe,"./pages/switch-page.ts":Je,"./pages/theme-generator-page.ts":Ye,"./pages/theming-page.ts":it}),st=new Map([[`/`,{elementName:`overview-page`,label:`Introduction`,wide:!1}],[`theming`,{elementName:`theming-page`,label:`Theming`,wide:!1}],[`theme-generator`,{elementName:`theme-generator-page`,label:`Theme Generator`,wide:!0}]]),ct=[`badge`,`button`,`input`,`checkbox`,`switch`,`combobox`];function lt(e){return e.split(`-`).map(e=>`${e.charAt(0).toUpperCase()}${e.slice(1)}`).join(` `)}function ut(e){let t=e.split(`/`).pop()?.replace(/-page\.ts$/,``)??``;return t===`overview`?`/`:t}var Q=Object.keys(ot).map(e=>{let t=ut(e),n=st.get(t);return{route:t,elementName:n?.elementName??`${t}-page`,label:n?.label??lt(t),wide:n?.wide??!1}}),dt=[`/`,`theming`,`theme-generator`].map(e=>Q.find(t=>t.route===e)).filter(e=>!!e),ft=Q.filter(e=>!st.has(e.route)).sort((e,t)=>{let n=ct.indexOf(e.route),r=ct.indexOf(t.route);return(n===-1?2**53-1:n)-(r===-1?2**53-1:r)||e.label.localeCompare(t.label)});function pt(e){return Q.find(t=>t.route===e)??Q.find(e=>e.route===`/`)??{route:`/`,elementName:`overview-page`,label:`Introduction`,wide:!1}}function mt(e){return D`
    <section>
      <h1>${lt(e)}</h1>
      <p>This page has not been registered yet.</p>
    </section>
  `}var ht=class extends I{constructor(...e){super(...e),this.active=``}static{this.styles=c`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}_renderNavItem(e){let t=e.route===`/`?`#/`:`#/${e.route}`;return D`
    ...
    `}_isActive(e){return this.active===e?`active`:``}render(){return D`
      <nav class="nav">
        ...
        ${dt.map(e=>this._renderNavItem(e))}

        <div class="nav-section">Components</div>
        ${ft.map(e=>this._renderNavItem(e))}

      </nav>
    `}};B([Re({type:String})],ht.prototype,`active`,void 0),ht=B([L(`app-sidebar`)],ht);var $=class extends I{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`,t=e===`/`?`/`:e.replace(/^\//,``);this._page=t,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=c`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=pt(this._page).wide?`content wide`:`content`;return D`
      <!-- topbar (mobile only) -->
      <header class="topbar">
        <button
          class="menu-btn"
    ...
    `}_renderPage(){let e=pt(this._page);if(!customElements.get(e.elementName))return mt(this._page);let t=Ne(e.elementName);return Fe`<${t}></${t}>`}};B([R()],$.prototype,`_page`,void 0),B([R()],$.prototype,`_sidebarOpen`,void 0),B([R()],$.prototype,`_dark`,void 0),$=B([L(`app-layout`)],$);