...
`;function G(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var K=class extends B{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1}static{this.styles=[W,o`
    :host {
      display: inline-flex;
    }
  ...
  `]}render(){return j`
    ...
    `}};G([H({type:String,reflect:!0})],K.prototype,`variant`,void 0),G([H({type:String,reflect:!0})],K.prototype,`size`,void 0),G([H({type:Boolean,reflect:!0})],K.prototype,`disabled`,void 0),K=G([V(`shadcx-button`)],K);var q=class extends B{constructor(...e){super(...e),this.variant=`default`}static{this.styles=[W,o`
      :host {
        display: inline-flex;
      }
    ...
    `}};G([H({type:String,reflect:!0})],q.prototype,`variant`,void 0),q=G([V(`shadcx-badge`)],q);var J=class extends B{constructor(...e){super(...e),this.type=`text`,this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.ariaInvalid=null}static{this.styles=[W,o`
    :host {
      display: flex;
    }
  ...
  `]}render(){return j`
      ...
      >
    `}};G([H({type:String})],J.prototype,`type`,void 0),G([H({type:String})],J.prototype,`placeholder`,void 0),G([H({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),G([H({type:Boolean,reflect:!0})],J.prototype,`required`,void 0),G([H({type:Boolean,reflect:!0})],J.prototype,`readonly`,void 0),G([H({type:String,attribute:`aria-invalid`})],J.prototype,`ariaInvalid`,void 0),J=G([V(`shadcx-input`)],J);var Y=class extends B{constructor(...e){super(...e),this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.rows=4,this.ariaInvalid=null}static{this.styles=[W,o`
      :host {
        display: flex;
      }
    ...
    `]}render(){return j`
      <textarea
        ...
        aria-invalid=${this.ariaInvalid||N}
      ></textarea>
    `}};G([H({type:String})],Y.prototype,`placeholder`,void 0),G([H({type:Boolean,reflect:!0})],Y.prototype,`disabled`,void 0),G([H({type:Boolean,reflect:!0})],Y.prototype,`required`,void 0),G([H({type:Boolean,reflect:!0})],Y.prototype,`readonly`,void 0),G([H({type:Number})],Y.prototype,`rows`,void 0),G([H({type:String,attribute:`aria-invalid`})],Y.prototype,`ariaInvalid`,void 0),Y=G([V(`shadcx-textarea`)],Y);var X=class extends B{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaInvalid=null}static{this.styles=[W,o`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `]}get _state(){return this.indeterminate?`indeterminate`:this.checked?`checked`:`unchecked`}_toggle(){this.disabled||(this.indeterminate?(this.indeterminate=!1,this.checked=!0):this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked,indeterminate:this.indeterminate,state:this._state},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return j`
    ...
    `}};G([H({type:Boolean,reflect:!0})],X.prototype,`checked`,void 0),G([H({type:Boolean,reflect:!0})],X.prototype,`indeterminate`,void 0),G([H({type:Boolean,reflect:!0})],X.prototype,`disabled`,void 0),G([H({type:String,attribute:`aria-invalid`})],X.prototype,`ariaInvalid`,void 0),X=G([V(`shadcx-checkbox`)],X);var Z=class extends B{constructor(...e){super(...e),this.active=``}static{this.styles=o`
    :host {
      display: flex;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}render(){let e=e=>this.active===e?`active`:``;return j`
      <nav class="nav">
        ...
        <a
          class="nav-item ${e(`textarea`)}"
          href="#/textarea"
          @click=${e=>this._navigate(`textarea`,e)}
        >
          Textarea
        </a>

      </nav>
    `}};G([H({type:String})],Z.prototype,`active`,void 0),Z=G([V(`app-sidebar`)],Z);var De=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_navigateBadge(e){e.preventDefault(),location.hash=`badge`}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}_navigateTextarea(e){e.preventDefault(),location.hash=`textarea`}render(){return j`
      <h1>shadcx</h1>
      <p class="lead">
...
&lt;script type="module" src="https://dobrinyonkov.github.io/shadcx/assets/index.js"&gt;&lt;/script&gt;</code></pre>
    ...
    `}};De=G([V(`overview-page`)],De);var Oe=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};Oe=G([V(`theming-page`)],Oe);var ke=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;shadcx-button variant="ghost" disabled&gt;Ghost&lt;/shadcx-button&gt;</code></pre>
    ...
    `}};ke=G([V(`button-page`)],ke);var Ae=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/a&gt;</code></pre>
  ...
  color: hsl(142 84% 25%);
    ...
    `}};Ae=G([V(`badge-page`)],Ae);var je=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};je=G([V(`input-page`)],je);var Me=class extends B{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};Me=G([V(`textarea-page`)],Me);var Q=class extends B{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/label&gt;</code></pre>
    ...
    `}};G([U()],Q.prototype,`_checked`,void 0),Q=G([V(`checkbox-page`)],Q);var $=class extends B{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`;this._page=e,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=this._dark?`☀`:`☽`;return j`
    ...
    `}_renderPage(){switch(this._page){case`badge`:return j`<badge-page></badge-page>`;case`button`:return j`<button-page></button-page>`;case`input`:return j`<input-page></input-page>`;case`checkbox`:return j`<checkbox-page></checkbox-page>`;case`textarea`:return j`<textarea-page></textarea-page>`;case`theming`:return j`<theming-page></theming-page>`;default:return j`<overview-page></overview-page>`}}};G([U()],$.prototype,`_page`,void 0),G([U()],$.prototype,`_sidebarOpen`,void 0),G([U()],$.prototype,`_dark`,void 0),$=G([V(`app-layout`)],$);