...
`;function z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var B=class extends P{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1}static{this.styles=[R,o`
    :host {
      display: inline-flex;
    }
  ...
  `]}render(){return T`
    ...
    `}};z([I({type:String,reflect:!0})],B.prototype,`variant`,void 0),z([I({type:String,reflect:!0})],B.prototype,`size`,void 0),z([I({type:Boolean,reflect:!0})],B.prototype,`disabled`,void 0),B=z([F(`shadcx-button`)],B);var V=class extends P{constructor(...e){super(...e),this.variant=`default`}static{this.styles=[R,o`
      :host {
        display: inline-flex;
      }
    ...
    `}};z([I({type:String,reflect:!0})],V.prototype,`variant`,void 0),V=z([F(`shadcx-badge`)],V);var H=class extends P{constructor(...e){super(...e),this.type=`text`,this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.ariaInvalid=null}static{this.styles=[R,o`
    :host {
      display: flex;
    }
  ...
  `]}render(){return T`
      <input
        ...
        aria-invalid=${this.ariaInvalid||D}
      >
    `}};z([I({type:String})],H.prototype,`type`,void 0),z([I({type:String})],H.prototype,`placeholder`,void 0),z([I({type:Boolean,reflect:!0})],H.prototype,`disabled`,void 0),z([I({type:Boolean,reflect:!0})],H.prototype,`required`,void 0),z([I({type:Boolean,reflect:!0})],H.prototype,`readonly`,void 0),z([I({type:String,attribute:`aria-invalid`})],H.prototype,`ariaInvalid`,void 0),H=z([F(`shadcx-input`)],H);var U=class extends P{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaInvalid=null}static{this.styles=[R,o`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `]}get _state(){return this.indeterminate?`indeterminate`:this.checked?`checked`:`unchecked`}_toggle(){this.disabled||(this.indeterminate?(this.indeterminate=!1,this.checked=!0):this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked,indeterminate:this.indeterminate,state:this._state},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return T`
      <button
        part="root"
        class="root"
        type="button"
      ...
      >
        <span part="indicator" class="indicator" aria-hidden="true">
          ${this._state===`checked`?T`<svg class="icon" viewBox="0 0 16 16"><polyline points="3.5 8.5 6.8 11.8 12.5 5.5" /></svg>`:this._state===`indeterminate`?T`<svg class="icon" viewBox="0 0 16 16"><line x1="3.5" y1="8" x2="12.5" y2="8" /></svg>`:D}
        </span>
      </button>
    `}};z([I({type:Boolean,reflect:!0})],U.prototype,`checked`,void 0),z([I({type:Boolean,reflect:!0})],U.prototype,`indeterminate`,void 0),z([I({type:Boolean,reflect:!0})],U.prototype,`disabled`,void 0),z([I({type:String,attribute:`aria-invalid`})],U.prototype,`ariaInvalid`,void 0),U=z([F(`shadcx-checkbox`)],U);var W=class extends P{constructor(...e){super(...e),this.active=``}static{this.styles=o`
    :host {
      display: flex;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}render(){let e=e=>this.active===e?`active`:``;return T`
      <nav class="nav">
        ...
        <a
          class="nav-item ${e(`dropdown-menu`)}"
          href="#/dropdown-menu"
          @click=${e=>this._navigate(`dropdown-menu`,e)}
        >
          Dropdown Menu
        </a>

      </nav>
    `}};z([I({type:String})],W.prototype,`active`,void 0),W=z([F(`app-sidebar`)],W);var Ne=class extends P{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_navigateBadge(e){e.preventDefault(),location.hash=`badge`}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}_navigateDropdownMenu(e){e.preventDefault(),location.hash=`dropdown-menu`}render(){return T`
      <h1>shadcx</h1>
      <p class="lead">
...
&lt;script type="module" src="https://dobrinyonkov.github.io/shadcx/assets/index.js"&gt;&lt;/script&gt;</code></pre>
    ...
    `}};Ne=z([F(`overview-page`)],Ne);var Pe=class extends P{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};Pe=z([F(`theming-page`)],Pe);var Fe=class extends P{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;shadcx-button variant="ghost" disabled&gt;Ghost&lt;/shadcx-button&gt;</code></pre>
    ...
    `}};Fe=z([F(`button-page`)],Fe);var Ie=class extends P{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/a&gt;</code></pre>
  ...
  color: hsl(142 84% 25%);
    ...
    `}};Ie=z([F(`badge-page`)],Ie);var Le=class extends P{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};Le=z([F(`input-page`)],Le);var G=class extends P{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/label&gt;</code></pre>
    ...
    `}};z([L()],G.prototype,`_checked`,void 0),G=z([F(`checkbox-page`)],G);var K=class extends P{constructor(...e){super(...e),this.open=!1,this._trigger=null,this._handleWindowKeyDown=e=>{e.key===`Escape`&&this.setOpen(!1)},this._handlePointerDown=e=>{e.composedPath().includes(this)||this.setOpen(!1)},this._onSelect=()=>{this.setOpen(!1)},this._onOpen=()=>{this.setOpen(!0)},this._onClose=()=>{this.setOpen(!1)}}static{this.styles=o`
    :host {
      display: inline-flex;
      position: relative;
    }
  `}connectedCallback(){super.connectedCallback(),this.addEventListener(`shadcx-dropdown-select`,this._onSelect),this.addEventListener(`shadcx-dropdown-open`,this._onOpen),this.addEventListener(`shadcx-dropdown-close`,this._onClose)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`shadcx-dropdown-select`,this._onSelect),this.removeEventListener(`shadcx-dropdown-open`,this._onOpen),this.removeEventListener(`shadcx-dropdown-close`,this._onClose),window.removeEventListener(`pointerdown`,this._handlePointerDown),window.removeEventListener(`keydown`,this._handleWindowKeyDown)}registerTrigger(e){this._trigger=e}toggle(){this.setOpen(!this.open)}setOpen(e){this.open!==e&&(this.open=e,this.dispatchEvent(new CustomEvent(`open-change`,{detail:{open:this.open},bubbles:!0,composed:!0})),this.open?(window.addEventListener(`pointerdown`,this._handlePointerDown),window.addEventListener(`keydown`,this._handleWindowKeyDown)):(window.removeEventListener(`pointerdown`,this._handlePointerDown),window.removeEventListener(`keydown`,this._handleWindowKeyDown),this._trigger?.focusTrigger()),this.querySelectorAll(`shadcx-dropdown-menu-content`).forEach(e=>{e.syncFromMenu()}))}render(){return T`<slot></slot>`}};z([I({type:Boolean,reflect:!0})],K.prototype,`open`,void 0),K=z([F(`shadcx-dropdown-menu`)],K);var Re=class extends P{constructor(...e){super(...e),this.disabled=!1}static{this.styles=[R,o`
      :host {
        display: inline-flex;
      }
    ...
    `]}connectedCallback(){super.connectedCallback(),this.menu?.registerTrigger(this)}get menu(){return this.closest(`shadcx-dropdown-menu`)}focusTrigger(){this.shadowRoot?.querySelector(`button`)?.focus()}_onClick(){this.menu?.toggle()}_onKeyDown(e){e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),this.menu?.toggle())}render(){return T`
      <button
        class="root"
        part="root"
        type="button"
        aria-haspopup="menu"
        aria-expanded=${String(this.menu?.open??!1)}
        ?disabled=${this.disabled}
        @click=${this._onClick}
        @keydown=${this._onKeyDown}
      >
    ...
    `}};z([I({type:Boolean,reflect:!0})],Re.prototype,`disabled`,void 0),Re=z([F(`shadcx-dropdown-menu-trigger`)],Re);var q=class extends P{constructor(...e){super(...e),this.open=!1,this.align=`start`}static{this.styles=[R,o`
      :host {
        position: absolute;
        z-index: 50;
        min-width: 12rem;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.syncFromMenu()}get menu(){return this.closest(`shadcx-dropdown-menu`)}syncFromMenu(){this.open=!!this.menu?.open,this.style.top=`calc(100% + 0.25rem)`,this.align===`end`?(this.style.right=`0`,this.style.left=`auto`):this.align===`center`?(this.style.left=`50%`,this.style.transform=`translateX(-50%)`,this.style.right=`auto`):(this.style.left=`0`,this.style.right=`auto`)}render(){return T`<div class="root" part="root" role="menu"><slot></slot></div>`}};z([I({type:Boolean,reflect:!0})],q.prototype,`open`,void 0),z([I({type:String})],q.prototype,`align`,void 0),q=z([F(`shadcx-dropdown-menu-content`)],q);var ze=class extends P{render(){return T`<slot></slot>`}};ze=z([F(`shadcx-dropdown-menu-group`)],ze);var Be=class extends P{static{this.styles=[R,o`
      :host {
        display: block;
        padding: 0.375rem 0.5rem;
        font-size: 0.75rem;
    ...
    `]}render(){return T`<slot></slot>`}};Be=z([F(`shadcx-dropdown-menu-label`)],Be);var Ve=class extends P{static{this.styles=[R,o`
      :host {
        display: block;
        margin: 0.25rem -0.25rem;
        border-top: 1px solid hsl(var(--border));
      }
    `]}render(){return D}};Ve=z([F(`shadcx-dropdown-menu-separator`)],Ve);var He=class extends P{static{this.styles=o`
    :host {
      margin-left: auto;
      font-size: 0.75rem;
  ...
  `}render(){return T`<slot></slot>`}};He=z([F(`shadcx-dropdown-menu-shortcut`)],He);var J=class extends P{constructor(...e){super(...e),this.variant=`default`,this.disabled=!1,this.inset=!1}static{this.styles=[R,o`
      :host {
        display: flex;
      }
    ...
    `]}_onClick(){this.disabled||(this.dispatchEvent(new CustomEvent(`item-select`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`shadcx-dropdown-select`,{bubbles:!0,composed:!0})))}render(){return T`
      <button
        class="root"
        part="root"
        type="button"
    ...
    `}};z([I({type:String,reflect:!0})],J.prototype,`variant`,void 0),z([I({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),z([I({type:Boolean,reflect:!0,attribute:`inset`})],J.prototype,`inset`,void 0),J=z([F(`shadcx-dropdown-menu-item`)],J);var Y=class extends P{constructor(...e){super(...e),this.checked=!1,this.disabled=!1}static{this.styles=[R,o`
      :host {
        display: flex;
      }
    ...
    `]}_onClick(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`shadcx-dropdown-select`,{bubbles:!0,composed:!0})))}render(){return T`
      <button
        class="root"
        part="root"
        type="button"
    ...
    `}};z([I({type:Boolean,reflect:!0})],Y.prototype,`checked`,void 0),z([I({type:Boolean,reflect:!0})],Y.prototype,`disabled`,void 0),Y=z([F(`shadcx-dropdown-menu-checkbox-item`)],Y);var Ue=class extends P{constructor(...e){super(...e),this.value=``}connectedCallback(){super.connectedCallback(),this.addEventListener(`radio-select`,this._onSelect)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`radio-select`,this._onSelect)}_onSelect(e){this.value=e.detail.value,this.querySelectorAll(`shadcx-dropdown-menu-radio-item`).forEach(e=>{e.syncFromGroup()}),this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return T`<slot></slot>`}};z([I({type:String})],Ue.prototype,`value`,void 0),Ue=z([F(`shadcx-dropdown-menu-radio-group`)],Ue);var X=class extends P{constructor(...e){super(...e),this.value=``,this._checked=!1}static{this.styles=[R,o`
      :host {
        display: flex;
      }
    ...
    `]}connectedCallback(){super.connectedCallback(),this.syncFromGroup()}get _group(){return this.closest(`shadcx-dropdown-menu-radio-group`)}syncFromGroup(){this._checked=this._group?.value===this.value}_onClick(){this.dispatchEvent(new CustomEvent(`radio-select`,{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`shadcx-dropdown-select`,{bubbles:!0,composed:!0}))}render(){return T`
    ...
    `}};z([I({type:String})],X.prototype,`value`,void 0),z([L()],X.prototype,`_checked`,void 0),X=z([F(`shadcx-dropdown-menu-radio-item`)],X);var We=class extends P{constructor(...e){super(...e),this._open=!1}static{this.styles=o`
    :host {
      position: relative;
      display: block;
    }
  ...
  `}setOpen(e){this._open=e,this.querySelectorAll(`shadcx-dropdown-menu-sub-content`).forEach(e=>{e.open=this._open})}render(){return T`<slot></slot>`}};z([L()],We.prototype,`_open`,void 0),We=z([F(`shadcx-dropdown-menu-sub`)],We);var Ge=class extends P{static{this.styles=[R,o`
      :host {
        display: flex;
      }
    ...
    `]}get _sub(){return this.closest(`shadcx-dropdown-menu-sub`)}_open(){this._sub?.setOpen(!0)}_close(){this._sub?.setOpen(!1)}render(){return T`
      <button class="root" part="root" type="button" role="menuitem" @mouseenter=${this._open} @mouseleave=${this._close} @focus=${this._open}>
        <slot></slot>
        <span class="chevron">›</span>
      </button>
    `}};Ge=z([F(`shadcx-dropdown-menu-sub-trigger`)],Ge);var Z=class extends P{constructor(...e){super(...e),this.open=!1}static{this.styles=[R,o`
      :host {
        position: absolute;
    ...
    `]}render(){return T`<div class="root" part="root"><slot></slot></div>`}};z([I({type:Boolean,reflect:!0})],Z.prototype,`open`,void 0),Z=z([F(`shadcx-dropdown-menu-sub-content`)],Z);var Q=class extends P{constructor(...e){super(...e),this._bookmarks=!0,this._showStatus=!1,this._position=`bottom`}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_onBookmarksChange(e){this._bookmarks=e.detail.checked}_onStatusChange(e){this._showStatus=e.detail.checked}_onPositionChange(e){this._position=e.detail.value}render(){return T`
      <h1>Dropdown Menu</h1>
      <p class="desc">
...
&lt;/shadcx-dropdown-menu&gt;</code></pre>
    ...
    `}};z([L()],Q.prototype,`_bookmarks`,void 0),z([L()],Q.prototype,`_showStatus`,void 0),z([L()],Q.prototype,`_position`,void 0),Q=z([F(`dropdown-menu-page`)],Q);var $=class extends P{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`;this._page=e,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=this._dark?`☀`:`☽`;return T`
      <!-- topbar (mobile only) -->
      <header class="topbar">
        <button
          class="menu-btn"
    ...
    `}_renderPage(){switch(this._page){case`badge`:return T`<badge-page></badge-page>`;case`button`:return T`<button-page></button-page>`;case`input`:return T`<input-page></input-page>`;case`checkbox`:return T`<checkbox-page></checkbox-page>`;case`dropdown-menu`:return T`<dropdown-menu-page></dropdown-menu-page>`;case`theming`:return T`<theming-page></theming-page>`;default:return T`<overview-page></overview-page>`}}};z([L()],$.prototype,`_page`,void 0),z([L()],$.prototype,`_sidebarOpen`,void 0),z([L()],$.prototype,`_dark`,void 0),$=z([F(`app-layout`)],$);