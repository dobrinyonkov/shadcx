...
`;function q(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var J=class extends H{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1}static{this.styles=[K,o`
    :host {
      display: inline-flex;
    }
  ...
  `]}render(){return N`
    ...
    `}};q([W({type:String,reflect:!0})],J.prototype,`variant`,void 0),q([W({type:String,reflect:!0})],J.prototype,`size`,void 0),q([W({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),J=q([U(`shadcx-button`)],J);var Y=class extends H{constructor(...e){super(...e),this.type=`text`,this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.ariaInvalid=null}static{this.styles=[K,o`
    :host {
      display: flex;
    }
  ...
  `]}render(){return N`
      <input
        ...
        aria-invalid=${this.ariaInvalid||F}
      >
    `}};q([W({type:String})],Y.prototype,`type`,void 0),q([W({type:String})],Y.prototype,`placeholder`,void 0),q([W({type:Boolean,reflect:!0})],Y.prototype,`disabled`,void 0),q([W({type:Boolean,reflect:!0})],Y.prototype,`required`,void 0),q([W({type:Boolean,reflect:!0})],Y.prototype,`readonly`,void 0),q([W({type:String,attribute:`aria-invalid`})],Y.prototype,`ariaInvalid`,void 0),Y=q([U(`shadcx-input`)],Y);var X=class extends H{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaInvalid=null}static{this.styles=[K,o`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `]}get _state(){return this.indeterminate?`indeterminate`:this.checked?`checked`:`unchecked`}_toggle(){this.disabled||(this.indeterminate?(this.indeterminate=!1,this.checked=!0):this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked,indeterminate:this.indeterminate,state:this._state},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return N`
      <button
        part="root"
        class="root"
        type="button"
      ...
      >
        <span part="indicator" class="indicator" aria-hidden="true">
          ${this._state===`checked`?N`<svg class="icon" viewBox="0 0 16 16"><polyline points="3.5 8.5 6.8 11.8 12.5 5.5" /></svg>`:this._state===`indeterminate`?N`<svg class="icon" viewBox="0 0 16 16"><line x1="3.5" y1="8" x2="12.5" y2="8" /></svg>`:F}
        </span>
      </button>
    `}};q([W({type:Boolean,reflect:!0})],X.prototype,`checked`,void 0),q([W({type:Boolean,reflect:!0})],X.prototype,`indeterminate`,void 0),q([W({type:Boolean,reflect:!0})],X.prototype,`disabled`,void 0),q([W({type:String,attribute:`aria-invalid`})],X.prototype,`ariaInvalid`,void 0),X=q([U(`shadcx-checkbox`)],X);var Z=class extends H{constructor(...e){super(...e),this.active=``}static{this.styles=o`
    :host {
      display: flex;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}render(){let e=e=>this.active===e?`active`:``;return N`
    ...
    `}};q([W({type:String})],Z.prototype,`active`,void 0),Z=q([U(`app-sidebar`)],Z);var Te=class extends H{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}render(){return N`
      <h1>shadcx</h1>
      <p class="lead">
...
&lt;script type="module" src="https://dobrinyonkov.github.io/shadcx/assets/index.js"&gt;&lt;/script&gt;</code></pre>
    ...
    `}};Te=q([U(`overview-page`)],Te);var Ee=class extends H{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/style&gt;</code></pre>
  ...
  --background: 0 0% 5%;
    ...
    `}};Ee=q([U(`theming-page`)],Ee);var De=class extends H{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;shadcx-button variant="ghost" disabled&gt;Ghost&lt;/shadcx-button&gt;</code></pre>
    ...
    `}};De=q([U(`button-page`)],De);var Oe=class extends H{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/div&gt;</code></pre>
    ...
    `}};Oe=q([U(`input-page`)],Oe);var Q=class extends H{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_onCheckedChange(e){let t=e.currentTarget;this._checked=!!t.checked}render(){return N`
      <h1>Checkbox</h1>
      <p class="desc">
...
&lt;/label&gt;</code></pre>
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=this._dark?`☀`:`☽`;return N`
      <!-- topbar (mobile only) -->
      <header class="topbar">
        <button
          class="menu-btn"
    ...
    `}_renderPage(){switch(this._page){case`button`:return N`<button-page></button-page>`;case`input`:return N`<input-page></input-page>`;case`checkbox`:return N`<checkbox-page></checkbox-page>`;case`theming`:return N`<theming-page></theming-page>`;default:return N`<overview-page></overview-page>`}}};q([G()],$.prototype,`_page`,void 0),q([G()],$.prototype,`_sidebarOpen`,void 0),q([G()],$.prototype,`_dark`,void 0),$=q([U(`app-layout`)],$);