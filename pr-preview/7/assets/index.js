...
`;function W(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var G=class extends z{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1}static{this.styles=[U,o`
  ...
  `]}render(){return k`
    ...
    `}};W([V({type:String,reflect:!0})],G.prototype,`variant`,void 0),W([V({type:String,reflect:!0})],G.prototype,`size`,void 0),W([V({type:Boolean,reflect:!0})],G.prototype,`disabled`,void 0),G=W([B(`shadcx-button`)],G);var K=class extends z{constructor(...e){super(...e),this.type=`text`,this.placeholder=``,this.disabled=!1,this.required=!1,this.readonly=!1,this.ariaInvalid=null}static{this.styles=[U,o`
    :host {
      display: flex;
    }
  ...
  `]}render(){return k`
      ...
      >
    `}};W([V({type:String})],K.prototype,`type`,void 0),W([V({type:String})],K.prototype,`placeholder`,void 0),W([V({type:Boolean,reflect:!0})],K.prototype,`disabled`,void 0),W([V({type:Boolean,reflect:!0})],K.prototype,`required`,void 0),W([V({type:Boolean,reflect:!0})],K.prototype,`readonly`,void 0),W([V({type:String,attribute:`aria-invalid`})],K.prototype,`ariaInvalid`,void 0),K=W([B(`shadcx-input`)],K);var q=class extends z{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaInvalid=null}static{this.styles=[U,o`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `]}get _state(){return this.indeterminate?`indeterminate`:this.checked?`checked`:`unchecked`}_toggle(){this.disabled||(this.indeterminate?(this.indeterminate=!1,this.checked=!0):this.checked=!this.checked,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`checked-change`,{detail:{checked:this.checked,indeterminate:this.indeterminate,state:this._state},bubbles:!0,composed:!0})))}_onKeyDown(e){e.key===`Enter`&&(e.preventDefault(),this._toggle())}render(){return k`
    ...
    `}};W([V({type:Boolean,reflect:!0})],q.prototype,`checked`,void 0),W([V({type:Boolean,reflect:!0})],q.prototype,`indeterminate`,void 0),W([V({type:Boolean,reflect:!0})],q.prototype,`disabled`,void 0),W([V({type:String,attribute:`aria-invalid`})],q.prototype,`ariaInvalid`,void 0),q=W([B(`shadcx-checkbox`)],q);var J=class extends z{constructor(...e){super(...e),this.items=[],this.placeholder=`Select an option`,this.disabled=!1,this.multiple=!1,this.showClear=!1,this.autoHighlight=!1,this.ariaInvalid=null,this.value=``,this.values=[],this._query=``,this._open=!1,this._highlightedIndex=-1,this._onWindowPointerDown=e=>{e.composedPath().includes(this)||(this._open=!1)}}static{this.styles=[U,o`
      :host {
        display: block;
        width: 100%;
        max-width: 24rem;
    ...
    `]}connectedCallback(){super.connectedCallback(),window.addEventListener(`pointerdown`,this._onWindowPointerDown)}disconnectedCallback(){window.removeEventListener(`pointerdown`,this._onWindowPointerDown),super.disconnectedCallback()}get _filteredItems(){let e=this._query.trim().toLowerCase();return e?this.items.filter(t=>t.toLowerCase().includes(e)):this.items}_toggleOpen(){this.disabled||(this._open=!this._open,this._open&&this.autoHighlight&&this._filteredItems.length>0&&(this._highlightedIndex=0))}_onInput(e){let t=e.currentTarget;this._query=t.value,this._open=!0,this.autoHighlight&&this._filteredItems.length>0?this._highlightedIndex=0:this._highlightedIndex=-1}_onKeyDown(e){if(!this._open&&e.key===`ArrowDown`){e.preventDefault(),this._open=!0,this._highlightedIndex=0;return}if(this._open){if(e.key===`ArrowDown`){e.preventDefault(),this._highlightedIndex=Math.min(this._highlightedIndex+1,this._filteredItems.length-1);return}if(e.key===`ArrowUp`){e.preventDefault(),this._highlightedIndex=Math.max(this._highlightedIndex-1,0);return}if(e.key===`Enter`&&this._highlightedIndex>=0){e.preventDefault(),this._selectItem(this._filteredItems[this._highlightedIndex]);return}e.key===`Escape`&&(this._open=!1,this._highlightedIndex=-1)}}_selectItem(e){if(this.multiple){this.values.includes(e)?this.values=this.values.filter(t=>t!==e):this.values=[...this.values,e],this._query=``,this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:this.values},bubbles:!0,composed:!0}));return}this.value=e,this._query=e,this._open=!1,this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}_clear(){this.value=``,this.values=[],this._query=``,this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:this.multiple?this.values:this.value},bubbles:!0,composed:!0}))}_onActionButtonClick(){let e=this.multiple?this.values.length>0:!!this.value;if(this.showClear&&e){this._clear();return}this._toggleOpen()}_removeValue(e){this.values=this.values.filter(t=>t!==e),this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:this.values},bubbles:!0,composed:!0}))}updated(){!this.multiple&&!this._query&&this.value&&(this._query=this.value)}render(){let e=this._filteredItems;return k`
      ...
      ${this._open?k`
          ...
          `:j}
    `}};W([V({attribute:!1})],J.prototype,`items`,void 0),W([V({type:String})],J.prototype,`placeholder`,void 0),W([V({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),W([V({type:Boolean,reflect:!0})],J.prototype,`multiple`,void 0),W([V({type:Boolean,attribute:`show-clear`})],J.prototype,`showClear`,void 0),W([V({type:Boolean,attribute:`auto-highlight`})],J.prototype,`autoHighlight`,void 0),W([V({type:String,attribute:`aria-invalid`})],J.prototype,`ariaInvalid`,void 0),W([V({type:String})],J.prototype,`value`,void 0),W([V({attribute:!1})],J.prototype,`values`,void 0),W([H()],J.prototype,`_query`,void 0),W([H()],J.prototype,`_open`,void 0),W([H()],J.prototype,`_highlightedIndex`,void 0),J=W([B(`shadcx-combobox`)],J);var Y=class extends z{constructor(...e){super(...e),this.active=``}static{this.styles=o`
    :host {
      display: flex;
  ...
  `}_navigate(e,t){t.preventDefault(),location.hash=e,this.active=e}render(){let e=e=>this.active===e?`active`:``;return k`
    ...
    `}};W([V({type:String})],Y.prototype,`active`,void 0),Y=W([B(`app-sidebar`)],Y);var Oe=class extends z{static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
  ...
  `}_navigateButton(e){e.preventDefault(),location.hash=`button`}_navigateInput(e){e.preventDefault(),location.hash=`input`}_navigateCombobox(e){e.preventDefault(),location.hash=`combobox`}render(){return k`
      <h1>shadcx</h1>
      <p class="lead">
...
&lt;/div&gt;</code></pre>
    ...
    `}};je=W([B(`input-page`)],je);var X=class extends z{constructor(...e){super(...e),this._checked=!1}static{this.styles=o`
    :host {
      display: block;
      font-family: var(--font-sans, 'Inter', system-ui, -apple-system, sans-serif);
    }
...
&lt;/label&gt;</code></pre>
    ...
    `}};W([H()],X.prototype,`_checked`,void 0),X=W([B(`checkbox-page`)],X);var Z=[`Next.js`,`SvelteKit`,`Nuxt.js`,`Remix`,`Astro`],Q=class extends z{constructor(...e){super(...e),this._singleValue=``,this._multipleValues=[]}static{this.styles=o`
  ...
  `}_onSingleValueChange(e){let t=e;this._singleValue=t.detail.value}_onMultipleValueChange(e){let t=e;this._multipleValues=t.detail.value}render(){return k`
    ...
    `}};W([H()],Q.prototype,`_singleValue`,void 0),W([H()],Q.prototype,`_multipleValues`,void 0),Q=W([B(`combobox-page`)],Q);var $=class extends z{constructor(){super(),this._page=`/`,this._sidebarOpen=!1,this._dark=!1,this._dark=window.matchMedia(`(prefers-color-scheme: dark)`).matches,this._applyTheme(),this._updatePage(),window.addEventListener(`hashchange`,()=>this._updatePage()),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{this._dark=e.matches,this._applyTheme()})}_updatePage(){let e=location.hash.slice(1)||`/`;this._page=e,this._sidebarOpen=!1}_applyTheme(){document.documentElement.classList.toggle(`dark`,this._dark),document.documentElement.style.colorScheme=this._dark?`dark`:`light`}_toggleTheme(){this._dark=!this._dark,this._applyTheme()}static{this.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 100svh;
  ...
  `}render(){let e=this._sidebarOpen?`sidebar open`:`sidebar`,t=this._sidebarOpen?`overlay open`:`overlay`,n=this._dark?`☀`:`☽`;return k`
    ...
    `}_renderPage(){switch(this._page){case`button`:return k`<button-page></button-page>`;case`input`:return k`<input-page></input-page>`;case`checkbox`:return k`<checkbox-page></checkbox-page>`;case`combobox`:return k`<combobox-page></combobox-page>`;case`theming`:return k`<theming-page></theming-page>`;default:return k`<overview-page></overview-page>`}}};W([H()],$.prototype,`_page`,void 0),W([H()],$.prototype,`_sidebarOpen`,void 0),W([H()],$.prototype,`_dark`,void 0),$=W([B(`app-layout`)],$);